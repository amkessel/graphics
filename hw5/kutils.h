...
{	
	...
	/* Computes the points on a circle of radius r (points are ordered counter-clockwise) */
	void ComputeCirclePoints(double r, point2 *points, int n);
	
	/* Computes the points on an arc spanning an angle of 'degrees' (points are ordered counter-clockwise) */
