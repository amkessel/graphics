...
#define FRONT_TEX        6
#define FORK_TOP_TEX     7
#define FORK_BOTTOM_TEX  8
unsigned int falcon_tex[NUM_TEXS]; // textures
char *falcon_tex_names[] = { (char*)"tex_bottom.bmp",
							 (char*)"tex_top.bmp",
							 (char*)"tex_side.bmp",
							 (char*)"tex_around.bmp",
							 (char*)"tex_canopy_top.bmp",
							 (char*)"tex_canopy_front.bmp",
							 (char*)"tex_front.bmp",
							 (char*)"tex_fork_top.bmp",
							 (char*)"tex_fork_bottom.bmp"};
